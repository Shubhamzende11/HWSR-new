...
export const environment = {
  ...
  isMockEnabled: true,
  apiUrl:   'http://localhost/hwsr/api/api.php?function=',
  // apiUrl:   'https://192.168.1.34/hwsr/api/api.php?function=',
  // apiUrl: 'https://mobicloudtech.com/Hwsrweb/api/api.php?function=',
