   ...
   plotOptions:{
    ...
    },
    {
      ...
      tooltip:{
        ...
        pointFormat:'ID:{point.id}<br>City:{point.name}<br>Pressure 1-min:{point.Pressure_1_min}<br>Pressure Insta:{point.Pressure_insta}<br>Wind Direction 1-min:{point.Wind_Dir1_min}<br>Wind Direction 3-min:{point.Wind_Dir3_min}<br>Wind Speed 1-min:{point.Wind_Speed_1_min}<br>Wind Speed Max:{point.Wind_Speed_max}<br>Wind Direction Max:{point.Wind_dir_max}<br>Wind Speed 3-min:{point.Wind_speed_3_min}',
      },
